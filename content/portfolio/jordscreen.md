...
At one point in 2021 I started getting ads for a product called the [Skylight Frame](https://www.skylightframe.com/), a smart photo frame. It occured to me that if I had one, I would use it to let my friends send me memes on it. I had a hard time finding the actual price on the website, as is often the case with expensive products, so I decided to make my own version, Jordscreen.
